//This x_moving is for using the spring contacts board with FFC cable
...
difference() {
    ...
    translate([-34.25, -17.5, 0]) cylinder(h=15, r=1.5);
    translate([1.25, -17.5, 0]) cylinder(h=15, r=1.5);
    //translate([-34.25, -7, 7]) cylinder(h=15, r=2.5);
    //translate([1.25, -7, 7]) cylinder(h=15, r=2.5);
    //slit for board
    translate([-31.5, -20, 0]) cube([30, 6, 7]);
}
//Cube for end stop
translate([5, -22, 0]) cube([12, 15, 12]);
translate([-31.5, -20, 1.5]) cube([30, 1.6, 6]);
...
module start() {
    ...
    // Base plate
    translate([-38.5,-22,0]) cube([44,79,7]);
}