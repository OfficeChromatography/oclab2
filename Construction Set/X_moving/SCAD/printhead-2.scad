//printhead for connection with FFC cable 
...
//cylinders to fix the board  
    translate([12, 0, -22]) rotate([-90, 0, 0]) cylinder(r=1.6, h=4);
    translate([-12, 0, -22]) rotate([-90, 0, 0]) cylinder(r=1.6, h=4);
    translate([12, 0, -8]) rotate([-90, 0, 0]) cylinder(r=1.6, h=4);
    translate([-12, 0, -8]) rotate([-90, 0, 0]) cylinder(r=1.6, h=4);
